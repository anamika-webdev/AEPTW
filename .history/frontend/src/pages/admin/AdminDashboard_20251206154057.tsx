...
// ✅ FIXED: No duplicate tables, pagination added to all tabs
              ...
              {users.length === 0 ? (
                ...
                paginatedData.map((user) => (
                  <tr key={user.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm border">{user.city}, {user.state}</td>
              ...
              {sites.length === 0 ? (
                ...
                paginatedData.map((site) => (
                  <tr key={site.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm border">{site.location}</td>
                    <td className="px-4 py-3 text-sm border">
                      {site.latitude}, {site.longitude}
                    </td>
                    <td className="px-4 py-3 text-sm border">{site.city}, {site.state}</td>
                    <td className="px-4 py-3 text-sm border">
                      <div className="flex gap-2">
                        <button
                          onClick={() => onEdit(site)}
