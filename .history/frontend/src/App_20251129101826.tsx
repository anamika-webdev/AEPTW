...
export default App;
'@ | Out-File -FilePath "frontend\src\App.tsx" -Encoding UTF8 -Force

Write-Host "✅ Fixed App.tsx" -ForegroundColor Green
Write-Host ""
Write-Host "Now clear browser cache and try again:" -ForegroundColor Yellow
Write-Host "1. Press Ctrl+Shift+Delete" -ForegroundColor White
Write-Host "2. Clear 'Cached images and files' and 'Cookies'" -ForegroundColor White
Write-Host "3. Refresh page (Ctrl+F5)" -ForegroundColor White
Write-Host "4. Login again" -ForegroundColor White