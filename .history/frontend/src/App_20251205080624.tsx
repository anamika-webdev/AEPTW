// COMPLETE FIXED App.tsx
// The issue: permit-detail was placed OUTSIDE the main content area
// Fix: Move it INSIDE the <main> tag with other pages
    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex flex-col flex-1 lg:ml-64">
        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8">
          {/* Admin Pages */}
          {currentPage === 'dashboard' && isAdmin && <AdminDashboard onNavigate={handleNavigate} />}
          ...
          {/* ✅ FIX: Moved permit-detail INSIDE the main tag */}
