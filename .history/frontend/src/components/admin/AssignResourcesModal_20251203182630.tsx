// frontend/src/components/admin/AssignResourcesModal.tsx
...
interface Assignments {
  sites: Array<Site & { assignment_id: number; assigned_at: string }>;
  workers: Array<Worker & { assignment_id: number; assigned_at: string }>;
}
  ...
  const fetchData = async () => {
    try {
      ...
      if (assignmentsData.success) {
        setCurrentAssignments(assignmentsData.data);
