...
import { Bell, Menu, LogOut, User as UserIcon, Mail, Phone, Briefcase } from 'lucide-react';
...
export default function Header({ currentUser, onMenuClick, onLogout }: HeaderProps) {
  ...
  // Mock notifications
  const notifications = [
    { id: 1, message: 'New permit requires approval', time: '5 min ago', unread: true },
    { id: 2, message: 'Site inspection completed', time: '1 hour ago', unread: true },
    { id: 3, message: 'Worker training reminder', time: '2 hours ago', unread: false },
  ];
