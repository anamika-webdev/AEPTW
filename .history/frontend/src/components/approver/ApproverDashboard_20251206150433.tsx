...
// ✅ FIXED: Pagination moved outside overflow-x-auto div
...
export default function ApproverDashboard({ initialTab = 'pending' }: ApproverDashboardProps) {
  ...
  // ✅ FIXED: Pagination now properly placed outside overflow wrapper
  const PermitTable = ({ 
    permits, 
    showActions 
  }: { 
    ...
    return (
      <div className="overflow-hidden bg-white rounded-lg shadow-md">
        {permits.length === 0 ? (
          ...
          <>
            {/* Table wrapper - ONLY table inside overflow-x-auto */}
            ...
            {/* ✅ PAGINATION - NOW OUTSIDE overflow-x-auto div */}
            <Pagination
