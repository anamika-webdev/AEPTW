...
'@ | Out-File -FilePath "backend\src\routes\auth.routes.js" -Encoding UTF8 -Force

Write-Host "✅ auth.routes.js file updated successfully!" -ForegroundColor Green
Write-Host "Now restart your server with: npm start" -ForegroundColor Yellow