...
const sitesRoutes = require('./src/routes/site.routes');
const usersRoutes = require('./src/routes/user.routes');
const vendorsRoutes = require('./src/routes/vendor.routes');
const permitsRoutes = require('./src/routes/permit.routes');
