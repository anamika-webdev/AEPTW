    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-600 mt-1">Step {currentStep} of 5</p>
          </div>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full h-10 px-3 rounded-md border border-input bg-transparent mt-1"
                required
              >
      ...
      {currentStep === 3 && (
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-slate-600 mb-4">Select all hazards that apply to this work</p>
      ...
      {currentStep === 4 && (
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-slate-600 mb-4">Select control measures for identified hazards</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-slate-600 mb-4">Select required PPE for this work</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {commonPPE.map((ppe) => (
                  <button
                    key={ppe}
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="bg-slate-50 rounded-lg p-6 space-y-4">
              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-2">Site & Location</h4>
              ...
              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-2">Work Description</h4>
                <p className="text-slate-900">{formData.work_description}</p>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <h4 className="text-sm font-medium text-slate-600 mb-2">Start Time</h4>
                  <p className="text-slate-900">{new Date(formData.start_time).toLocaleString()}</p>
                </div>
                <div>
                  <h4 className="text-sm font-medium text-slate-600 mb-2">End Time</h4>
                  <p className="text-slate-900">{new Date(formData.end_time).toLocaleString()}</p>
                </div>
              </div>

              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-2">Permit Type</h4>
              ...
              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-2">Identified Hazards ({formData.hazards.length})</h4>
                <div className="flex flex-wrap gap-2">
                  {formData.hazards.map((hazard) => (
                    <span key={hazard} className="px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-xs">
                      {hazard}
                    </span>
                  ))}
                </div>
              ...
              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-2">Control Measures ({formData.control_measures.length})</h4>
                <div className="flex flex-wrap gap-2">
                  {formData.control_measures.map((control) => (
                    <span key={control} className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">
                      {control}
                    </span>
                  ))}
                </div>
              ...
              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-2">Required PPE ({formData.ppe_required.length})</h4>
                <div className="flex flex-wrap gap-2">
                  {formData.ppe_required.map((ppe) => (
                    <span key={ppe} className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-xs">
                      {ppe}
                    </span>
                  ))}
                </div>
              ...
              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-2">Receiver</h4>
