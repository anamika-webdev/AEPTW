    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage permits and workers</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 mt-1">Not submitted</p>
          </CardContent>
        </Card>
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">Fill out the safety checklist and assign workers</p>
            </div>
            <Button onClick={() => onNavigate('create-permit')} className="bg-green-600 hover:bg-green-700">
              <Plus className="w-4 h-4 mr-2" />
              Create Permit
