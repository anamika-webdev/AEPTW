...
import { Users, Search, Mail, Phone, MapPin, HardHat } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">View all workers in the system</p>
        </div>
      </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    <code className="bg-slate-100 px-2 py-1 rounded">{worker.login_id}</code>
                  </p>
                </div>
              </div>
            </CardHeader>
