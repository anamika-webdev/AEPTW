  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen px-4 py-12 overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <div className="flex items-center justify-center mb-6">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-amber-500 rounded-2xl blur-lg opacity-75 group-hover:opacity-100 transition duration-300"></div>
              <div className="relative flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl shadow-lg">
        ...
        {/* Signup Form */}
        <div className="p-8 bg-white/90 backdrop-blur-xl shadow-xl rounded-2xl border border-white/20">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-12 pr-4 py-3.5 text-gray-900 placeholder-gray-400 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 sm:text-sm ${validationErrors.email
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-12 pr-4 py-3.5 text-gray-900 placeholder-gray-400 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 sm:text-sm ${validationErrors.full_name
                    ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                    : 'border-gray-300 focus:ring-blue-500 focus:border-transparent'
                    }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-12 pr-4 py-3.5 text-gray-900 placeholder-gray-400 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 sm:text-sm ${validationErrors.password
                    ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                    : 'border-gray-300 focus:ring-blue-500 focus:border-transparent'
                    }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-12 pr-4 py-3.5 text-gray-900 placeholder-gray-400 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 sm:text-sm ${validationErrors.confirmPassword
                    ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                    : 'border-gray-300 focus:ring-blue-500 focus:border-transparent'
                    }`}
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={loading}
                className="relative flex justify-center w-full px-4 py-3.5 text-sm font-semibold text-white transition-all duration-200 bg-gradient-to-r from-orange-600 to-amber-600 border border-transparent rounded-xl hover:from-orange-700 hover:to-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                {loading ? (
        ...
        {/* Info Box */}
        <div className="p-4 mt-6 border border-orange-200 rounded-xl bg-gradient-to-r from-orange-50 to-amber-50">
          <div className="flex">
            <svg className="flex-shrink-0 w-5 h-5 text-orange-500" viewBox="0 0 20 20" fill="currentColor">
